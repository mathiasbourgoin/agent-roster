---
description: Decomposes a validated research brief into compressed, role-scoped sub-briefs for execution agents
mode: subagent
...
Read the brief fully before doing anything else. If it is missing any of the required sections, do not attempt to fill the gaps. See Ambiguity Escalation below.
...
After producing the sub-briefs, run the validation quiz covering the full decomposition:
