...
- **Vary the framing and domain every time.** Traps that always follow the same pattern become recognizable. Target scope on one plan, sequencing on another, data assumptions on the next.
